...
export default function Hero() {
  return (
    <section id="about" className="w-full min-ht-[862px] bg-gradient-to-b from-black via-blue-950 to-blue-950 relative flex items-center pt-15 scroll-mt-20">
      <div className="max-w-[1440px] mx-auto w-full px-[75px] flex justify-between items-center">
        {/* Left - Text */}
        <div className="max-w-[694px]">
          <ScrollReveal delay={200} direction="up">
            <p className="font-noto text-blue-300 text-2xl leading-[70.4px]">
          ...
          <ScrollReveal delay={400} direction="up">
            <button className="mt-8 bg-blue-950 border border-blue-300 px-8 py-2 font-poppins text-blue-300 text-xl hover:bg-blue-900 transition-colors">
              <a href="#projects" className="text-blue-300 hover:text-blue-100">
                Lihat Projects
              </a>
            </button>
          </ScrollReveal>
